...
var PAGE_2 = [
  ...
  [
    null,
    { channel: 178, index: 89, type: 'knob', command: 'sendLevel', track: 2, send: 0 },
    null,
    { channel: 178, index: 10, type: 'button', grouped: true, command: 'scenePlay', scene: 2 }
  ],
  [
    null,
    { channel: 178, index: 89, type: 'knob', command: 'sendLevel', track: 3, send: 0 },
    null,
    { channel: 178, index: 11, type: 'button', grouped: true, command: 'scenePlay', scene: 3 }
  ],
  [
    null,
    { channel: 178, index: 89, type: 'knob', command: 'sendLevel', track: 4, send: 0 },
    null,
    { channel: 178, index: 12, type: 'button', grouped: true, command: 'scenePlay', scene: 4 }
  ],
  [
    null,
    { channel: 178, index: 89, type: 'knob', command: 'sendLevel', track: 5, send: 0 },
    null,
    { channel: 178, index: 13, type: 'button', grouped: true, command: 'scenePlay', scene: 5 }
  ],
  [
    null,
    { channel: 178, index: 89, type: 'knob', command: 'sendLevel', track: 6, send: 0 },
    null,
    { channel: 178, index: 14, type: 'button', grouped: true, command: 'scenePlay', scene: 6 }
  ],
  [
    null,
    { channel: 178, index: 89, type: 'knob', command: 'sendLevel', track: 7, send: 0 },
    null,
