...
var PAGE_1 = [
  [
    ...
    { channel: 177, index: 8, type: 'button', inverted: true, command: 'mute', track: 0 },
  ...
  [
    ...
    { channel: 177, index: 9, type: 'button', inverted: true, command: 'mute', track: 1 },
  ...
  [
    ...
    { channel: 177, index: 10, type: 'button', inverted: true, command: 'mute', track: 2 },
  ...
  [
    ...
    { channel: 177, index: 11, type: 'button', inverted: true, command: 'mute', track: 3 },
  ...
  [
    ...
    { channel: 177, index: 12, type: 'button', inverted: true, command: 'mute', track: 4 },
  ...
  [
    ...
    { channel: 177, index: 13, type: 'button', inverted: true, command: 'mute', track: 5 },
  ...
  [
    ...
    { channel: 177, index: 14, type: 'button', inverted: true, command: 'mute', track: 6 },
  ...
  [
    ...
    { channel: 177, index: 15, type: 'button', inverted: true, command: 'mute', track: 7 },
